  ...
  async function getDashboard() {
    try {
      ...
      if (branchJson.success) {
        ...
        const sorted = branches.sort((a, b) => b.branch_score - a.branch_score);
    ...
    <div className="space-y-6 rounded-lg bg-white p-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Branch Point Ranking</p>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button onClick={getDashboard} disabled={loading}>
          ...
          : areaData.map((area) => (
              <div
                ...
                <div className="flex justify-evenly items-center flex-wrap gap-5">
                  <DonatChart
                    value={area.total_progress}
                    total={area.need_check}
                  />
      ...
      <div>
        Efective day : <span>{efectiveDay}</span>
      </div>
